// ThCGALCore.cpp : This file contains the 'main' function. Program execution begins and ends there.
//

#include "ThCGALUtils/ThCGALUtils.h"

int main(int argc, char** argv)
{
    double* buffer = new double[8 * 3];
    ThCGALMeshOBBFromFile("D:\\beam.stl", buffer);
}
